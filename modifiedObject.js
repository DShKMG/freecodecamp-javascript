...
you will see even more versatile applications of objects. 
Additionally, the Data Structures lessons located in the Coding Interview Prep section of the curriculum 
also cover the ES6 Map and Set objects, both of which are similar to ordinary objects but provide 
some additional features. Now that you've learned the basics of arrays and objects, 
...
function addFriend(userObj, friend) {
    user.data.friends.push(friend); // Array pushing object to the last similar with 
    //C++ / vector.push_back(var);
    return user.data.friends; // Returns as array
}
//addFriend(user, 'Pete')
